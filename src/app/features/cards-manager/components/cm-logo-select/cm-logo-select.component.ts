...
import { LogoSelectOption } from '../../models/bank-card';

@Component({
  selector: 'app-cm-logo-select',
  standalone: true,
  imports: [FormsModule],
  templateUrl: './cm-logo-select.component.html',
  styleUrl: './cm-logo-select.component.scss'
})
export class CmLogoSelect {
  readonly label = input.required<string>();
  readonly placeholder = input('Sélectionner...');
  readonly options = input.required<LogoSelectOption[]>();
  readonly value = input<string | null>(null);
  readonly showLogos = input(true);
  ...
  selectOption(option: LogoSelectOption): void {
  ...
  showLogo(option: LogoSelectOption): boolean {
